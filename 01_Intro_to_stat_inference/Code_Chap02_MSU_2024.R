...
get_MLE(out, 5)           # function from the ASMbook package; OAC: this packages do not exist!
...
# MCMC settings
na <- 2000; 
ni <- 12000; #number of iterations in the sampling phase 
nb <- 2000; #number of iterations in the adaptive phase (burning)
